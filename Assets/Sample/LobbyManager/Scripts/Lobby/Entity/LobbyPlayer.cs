...
namespace Bolt.Samples.Photon.Lobby
{
    public class LobbyPlayer : Bolt.EntityEventListener<ILobbyPlayerInfoState>
    {
        ...
        protected static Color JoinColor = new Color(255.0f / 255.0f, 0.0f, 101.0f / 255.0f, 1.0f);
        protected static Color NotReadyColor = new Color(34.0f / 255.0f, 44 / 255.0f, 55.0f / 255.0f, 1.0f);
        protected static Color ReadyColor = new Color(0.0f, 204.0f / 255.0f, 204.0f / 255.0f, 1.0f);
        protected static Color TransparentColor = new Color(0, 0, 0, 0);
        ...
        public override void Attached()
        {
            ...
            if (entity.IsOwner)
            {
                SetupStateOnAttached();
            }
        }

        protected virtual void SetupStateOnAttached()
        {
...
//            if (OnDetach != null) OnDetach.Invoke(this);
        ...
        protected void ChangeReadyButtonColor(Color c)
        {
