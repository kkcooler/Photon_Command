...
namespace Bolt.Samples.Photon.Lobby
{
    public partial class LobbyManager : Bolt.GlobalEventListener
    {
        ...
        [SerializeField] protected SceneField lobbyScene;
        [SerializeField] protected SceneField gameScene;
        ...
        protected bool isCountdown = false;
        protected string matchName;
        protected bool randomJoin = false;
        ...
        protected virtual void VerifyReady()
        {
            var allReady = true;
            var readyCount = 0;
        ...
        protected IEnumerator ServerCountdownCoroutine()
        {
        ...
        public override void BoltShutdownBegin(AddCallback registerDoneCallback)
        {
            ...
            if (lobbyScene.IsLoaded == false)
            {
                if (BoltNetwork.IsServer)
                {
                    ...
                    BoltNetwork.LoadScene(lobbyScene.SceneName);
                }
                else if (BoltNetwork.IsClient)
                {
        ...
        protected virtual BoltEntity CreatePlayerInfo()
        {
            return BoltNetwork.Instantiate(BoltPrefabs.PlayerInfo);
        }
    }
}